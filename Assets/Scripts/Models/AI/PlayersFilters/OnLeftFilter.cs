...
{
public class OnLeftFilter : PlayersFilter
{
    public OnLeftFilter(List<GameObject> players, List<GameObject> oponents, GameObject ball) : base(players, oponents, ball){}
